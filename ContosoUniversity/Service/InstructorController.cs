...
namespace ContosoUniversity.Controllers.Api
{
    public class InstructorController : ApiController
    {
        ...
        {
            return _mapper.Map<List<InstructorDto>>(await _unitOfWork.Instructor.GetAllAsync());
        }

        // GET api/student/5 
        public async Task<InstructorDto> Get(int id)
        {
            return _mapper.Map<InstructorDto>(await _unitOfWork.Instructor.GetByIdAsync(id));
        }
